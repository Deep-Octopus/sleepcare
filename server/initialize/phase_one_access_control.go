...
var phaseOneMenuSpecs = []phaseOneMenuSpec{
	...
	{Name: "CareQuestionnaires", ParentName: "CareContent", Path: "questionnaire-versions", Component: "view/sleep-care/questionnaires/index.vue", Title: "问卷版本", Icon: "version-gva", Sort: 1},
	{Name: "CarePlans", ParentName: "CareContent", Path: "plan-versions", Component: "view/sleep-care/plans/index.vue", Title: "OSA 方案", Icon: "config-file-gva", Sort: 2},
...
var phaseOneHiddenButtonSpecs = map[string][]phaseOneButtonSpec{
	"CareClientDetail": {
		...
		{Name: "startPlan", Desc: "预览并启动测试计划"},
		{Name: "pausePlan", Desc: "暂停测试计划"},
		{Name: "resumePlan", Desc: "恢复测试计划"},
	},
	"CareTaskDetail": {
...
var phaseOneMenuAccess = map[uint][]string{
	syntheticStewardRole: {
		...
		"CareDeliveries", "CareContent", "CarePlans", "CareClientDetail", "CareTaskDetail", "CareAttentionCaseDetail",
	},
	syntheticClinicianRole: {
		"SleepCare", "CareWorkbench", "CareClients", "CareExecution", "CareTasks", "CareAttentionCases",
		"CareDeliveries", "CareContent", "CareQuestionnaires", "CarePlans", "CareClientDetail", "CareTaskDetail", "CareAttentionCaseDetail",
	},
	syntheticSupervisorRole: {
		...
		"CareClientDetail", "CareTaskDetail", "CareAttentionCaseDetail", "CareReviewDetail",
	},
